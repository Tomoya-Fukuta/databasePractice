...
CREATE TABLE countries (
  code CHAR(3) NOT NULL DEFAULT '',              -- 国コード
  name CHAR(52) NOT NULL DEFAULT '',            -- 国名
  continent TEXT NOT NULL DEFAULT 'Asia',       -- 大陸
  region CHAR(26) NOT NULL DEFAULT '',          -- 地方
  surface_area NUMERIC(10, 2) NOT NULL DEFAULT 0.00, -- 表面積
  indep_year SMALLINT DEFAULT NULL,             -- 独立記念日
  population INT NOT NULL DEFAULT 0,            -- 人口
  life_expectancy NUMERIC(3, 1) DEFAULT NULL,   -- 平均寿命
  gnp NUMERIC(10, 2) DEFAULT NULL,              -- 国内総生産
  gnp_old NUMERIC(10, 2) DEFAULT NULL,          -- 古いGNP値
  local_name CHAR(45) NOT NULL DEFAULT '',      -- 現地名
  government_form CHAR(45) NOT NULL DEFAULT '', -- 政治形態
  hea_of_state CHAR(60) DEFAULT NULL,           -- 国家元首
  capital INT DEFAULT NULL,                     -- 首都ID
  code2 CHAR(2) NOT NULL DEFAULT '',            -- 国コード
  PRIMARY KEY (code)                            -- 主キー
);

INSERT INTO countries (code, name, continent, region, surface_area, indep_year, population,
life_expectancy, gnp, gnp_old, local_name, government_form, hea_of_state, capital, code2)
VALUES
...
CREATE TABLE countrylanguages (
  country_code CHAR(3) NOT NULL DEFAULT '',         -- 国コード
  language CHAR(30) NOT NULL DEFAULT '',           -- 言語
  is_official BOOLEAN NOT NULL DEFAULT FALSE,      -- BOOL型に変換（'T', 'F'を使用しない）
  percentage NUMERIC(4, 1) NOT NULL DEFAULT 0.0,   -- NUMERIC型を使用（精度指定）
  PRIMARY KEY (country_code, language),            -- 複合主キーの定義
  CONSTRAINT fk_country_code FOREIGN KEY (country_code) REFERENCES countries (code) -- 外部キー制約
);

INSERT INTO countrylanguages (country_code, language, is_official, percentage)
VALUES
('ABW','Dutch','T',5.3),
('ABW','English','F',9.5),
...
CREATE TABLE celebrities (
  ...
  country_code CHAR(3) DEFAULT '',       -- 国コード
  birth TIMESTAMP DEFAULT NULL,          -- 誕生日
  age INT DEFAULT NULL,                  -- 年齢
  occupation CHAR(52) NOT NULL DEFAULT '' -- 職業
);

INSERT INTO celebrities (id, name, country_code, birth, age, occupation)
VALUES
...
CREATE TABLE cities (
  ...
  country_code CHAR(3) NOT NULL DEFAULT '', -- 国コード
  district CHAR(20) NOT NULL DEFAULT '',    -- 地区
  population INT NOT NULL DEFAULT 0,        -- 人口
  CONSTRAINT fk_country_code FOREIGN KEY (country_code) REFERENCES countries (code) -- 外部キー制約
);

INSERT INTO cities (id, name, country_code, district, population)
VALUES
