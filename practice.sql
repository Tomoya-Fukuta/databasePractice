...
SELECT name FROM countries WHERE TRIM(name) LIKE '%st%';

-- 問11
-- 名前が「an」で始まる国を抽出してください。
SELECT name FROM countries WHERE TRIM(name) LIKE 'an%';
...
SELECT countries.name AS country_name, countrylanguages.language, cities.name AS city_name
FROM countries
JOIN countrylanguages ON countries.code = countrylanguages.country_code
...
SELECT celebrities.name AS celebrity_name, countries.name AS country_name
FROM celebrities
...
SELECT celebrities.name AS celebrity_name, 
       (SELECT name FROM countries WHERE countries.code = celebrities.country_code) AS country_name
FROM celebrities;
...
SELECT COUNT(*) AS count_1991 FROM celebrities WHERE EXTRACT(YEAR FROM birth) = 1991
UNION ALL
SELECT COUNT(*) AS count_1981 FROM celebrities WHERE EXTRACT(YEAR FROM birth) = 1981;
